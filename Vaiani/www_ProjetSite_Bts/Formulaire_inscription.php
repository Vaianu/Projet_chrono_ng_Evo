...
<head>
	...
	<title>Inscription - chrono_ng</title>
</head>
...
<body>
	...
	<h1>
			...
			<a href="Formulaire_inscription.php"><span>INSCRIPTION</span></a>
	...
	<h3>
		<a class="menu" href="http://localhost/">Acceuil</a> <em>>></em> Incription
	</h3>
	...
	<footer style="position: absolute; bottom:0;" >© 2019 BTS SN-IR du Couffignal</footer>
</body>
</html>